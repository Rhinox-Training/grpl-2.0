...
/// <summary>
/// A Unity component used to wrap a <see cref="GRPLButtonInteractable"/> and expose its events as Unity events in the editor.
/// </summary>
public class GRPLButtonInteractableUnityWrapper : MonoBehaviour
{
    /// <summary>
    /// the reference to the GRPLButtonInteractable component to be wrapped.
    /// </summary>
    [SerializeField] private GRPLButtonInteractable _interactable;

    /// <summary>
    /// A Unity event called when an object is in proximity of the GRPLButtonInteractable.
    /// </summary>
    [SerializeField] private UnityEvent _onProximityStart;
    /// <summary>
    /// A Unity event called when an object is no longer in proximity of the GRPLButtonInteractable.
    /// </summary>
    [SerializeField] private UnityEvent _onProximityEnd;
    /// <summary>
    /// A Unity event called when an object starts interacting with the GRPLButtonInteractable
    /// </summary>
    [SerializeField] private UnityEvent _onInteractedStart;
    /// <summary>
    /// A Unity event called when an object stops interacting with the GRPLButtonInteractable.
    /// </summary>
    ...
    /// <summary>
    /// A method called when the GRPLButtonInteractable starts interacting with an object.
    ...
    /// <summary>
    /// A method called when the GRPLButtonInteractable stops interacting with an object. Invokes the _onInteractedEnd Unity event.
    /// </summary>
    /// <param name="obj"></param>
    private void OnInteractableEnded(GRPLInteractable obj) => OnInteractedEnd.Invoke();
    /// <summary>
    /// A method called when an object enters the proximity of the GRPLButtonInteractable. Invokes the _onProximityStart Unity event.
    /// </summary>
    /// <param name="obj"></param>
    private void OnInteractableProximityStarted(GRPLInteractable obj) => OnProximityStart.Invoke();
    /// <summary>
    /// A method called when an object leaves the proximity of the GRPLButtonInteractable. Invokes the _onProximityEnd Unity event.
    /// </summary>
