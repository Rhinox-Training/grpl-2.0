...
public class GRPLHandVisualizer : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        InstantiateHand(RhinoxHand.Left, _leftJoints, _leftHandRoot.transform, _leftHandPrefab, out _leftHandRenderer);
    ...
    private void InstantiateHand(RhinoxHand hand, List<GameObject> jointObjects, Transform parent, GameObject prefab,
    ...
    private void OnTrackingAcquired(RhinoxHand hand)
    {
        ...
        switch (hand)
        {
            ...
            case RhinoxHand.Invalid:
            default:
                PLog.Error<GrappleLogger>($"[GRPLHandVisualizer,OnTrackingAcquired], function called with invalid hand value: {hand}");
                return;
        }
